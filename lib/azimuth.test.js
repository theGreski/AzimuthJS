...
describe('Validation tests', () => {
    test('Validate Point', () => {
            ...
            try {
                ...
                expect(error).toThrow('At least one point is missing!');
          }
    ...
    test('Validate Latitude', () => {
        expect(azimuth({ lat: 190, lng: 0 },{ lat: 190, lng: 0 })).toThrow(Error);
    });

    test('Validate Longitude', () => {
        expect(azimuth({ lat: 0, lng: 100 },{ lat: 0, lng: 100 })).toThrowError(Error);
    });
